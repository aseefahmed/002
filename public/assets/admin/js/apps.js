...
//            BlankonApp.handleSparkline();
        ...
        handleBaseURL: function () {
            var getUrl = window.location,
                baseUrl = getUrl .protocol + "//" + getUrl.host + "/" + getUrl.pathname.split('http://themes.djavaui.com/')[1];
            return baseUrl;
        },
        ...
        handleSound: function () {
            if($('.page-sound').length){
                ...
                ion.sound({
                    ...
                    path: 'http://themes.djavaui.com/blankon-fullpack-admin-theme' + '/assets/global/plugins/bower_components/ionsound/sounds/',
                    preload: true
                });
