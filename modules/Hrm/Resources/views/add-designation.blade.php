            ...
            <div class="col-md-12">
                ...
                <div class="panel rounded shadow">
                    ...
                    <div class="panel-body no-padding">
                        ...
                        <form class="form-horizontal form-bordered" role="form" method="POST" name="add_designation_form" id="add_designation_form">
                            ...
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control input-sm" name="designation_name" placeholder="Designation Name">
                                    </div>
                                </div><!-- /.form-group -->
                                <div class="form-group">
                            ...
                            <div class="form-footer">
                                <div class="col-sm-offset-3">
                                    ...
                                    <a class="btn btn-bitbucket" data-toggle="modal" data-target="#myModal">Create</a>
                                </div>
                            </div><!-- /.form-footer -->
                        </form>
        ...
        <div class="modal-dialog" role="document" style="margin: 150px auto;">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            Do you really want to create a designation?
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary btn-lg btn-slideright" id="add-designation-btn">YES</a>
                </div>
            </div>
        </div>
    </div>
