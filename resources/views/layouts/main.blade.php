...
<head>
    ...
    <!--[if lt IE 9]>
    <script src="{{ url('public/assets/global/plugins/bower_components/html5shiv/dist/html5shiv.min.js') }}"></script>
    <script src="{{ url('public/assets/global/plugins/bower_components/respond-minmax/dest/respond.min.js') }}"></script>
    <![endif]-->
    <!--/ END IE SUPPORT -->
</head>
<!--/ END HEAD -->
...
<section id="wrapper">
                ...
                <ul class="nav navbar-nav navbar-right"><!-- /.nav navbar-nav navbar-right -->
                    ...
                    <li id="tour-6" class="dropdown navbar-profile">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <span class="meta">
                                    <span class="avatar"><img src="{{ url('public/img/avatar/35/1.png') }}" class="img-circle" alt="admin"></span>
    ...
    <aside id="sidebar-left" class="sidebar-circle">
        ...
        <div id="tour-8" class="sidebar-content">
            <div class="media">
                <a class="pull-left has-notif avatar" href="page-profile.html">
                    <img src="{{ url('public/img/avatar/50/1.png') }}" alt="admin">
                    <i class="online"></i>
                </a>
                <div class="media-body">
        ...
        <ul id="tour-9" class="sidebar-menu">
                ...
                <ul>
                    ...
                    <li class="submenu">
                        <a href="javascript:void(0);">
                            ...
                            <span class="count label label-danger">7</span>
                            <span class="arrow"></span>
                        </a>
                        <ul>
            ...
            <li>
                <a href="http://themes.djavaui.com/blankon-fullpack-admin-theme/documentation/admin/html/live-preview-documentation.html" target="_blank">
        ...
        <div class="body-content animated fadeIn">
            ...
            <div class="row">
                <div class="col-md-9">
                    ...
                    <div class="table-responsive rounded mb-20">
                        <table id="tour-16" class="table table-striped table-theme">
                            ...
                            <tr>
                                ...
                                <td>
                                    <img src="{{ url('public/img/avatar/35/2.png') }}" class="img-circle img-bordered-theme" alt="John Kribo">
                            ...
                            <tr>
                                ...
                                <td>
                                    <img src="{{ url('public/img/avatar/35/3.png') }}" class="img-circle img-bordered-theme" alt="Jennifer Poiyem">
                            ...
                            <tr>
                                ...
                                <td>
                                    <img src="{{ url('public/img/avatar/35/4.png') }}" class="img-circle img-bordered-theme" alt="Clara Wati">
                            ...
                            <tr>
                                ...
                                <td>
                                    <img src="{{ url('public/img/avatar/35/5.png') }}" class="img-circle img-bordered-theme" alt="Toni Mriang">
                            ...
                            <tr>
                                ...
                                <td>
                                    <img src="{{ url('public/img/avatar/35/6.png') }}" class="img-circle img-bordered-theme" alt="Bella negoro">
                    ...
                    <!-- Start dropzone js -->
                    <div id="tour-18">
                        <form id="my-dropzone" action="http://themes.djavaui.com/blankon-fullpack-admin-theme/assets/admin/data" class="dropzone mb-20 rounded">
                            <div class="fallback">
...
<script src="{{ url('public/assets/global/plugins/bower_components/typehead.js/dist/handlebars.js') }}"></script>
<script src="{{ url('public/assets/global/plugins/bower_components/typehead.js/dist/typeahead.bundle.min.js') }}"></script>
<script src="{{ url('public/assets/global/plugins/bower_components/jquery-nicescroll/jquery.nicescroll.min.js') }}"></script>
<script src="{{ url('public/assets/global/plugins/bower_components/jquery.sparkline.min/index.js') }}"></script>
...
<script src="{{ url('public/assets/global/plugins/bower_components/skycons-html5/skycons.js') }}"></script>
...
<script src="{{ url('public/assets/global/plugins/bower_components/bootstrap-tour/build/js/bootstrap-tour.min.js') }}"></script>
...
<!-- Mirrored from themes.djavaui.com/blankon-fullpack-admin-theme/live-preview/admin/html/dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Apr 2016 17:26:47 GMT -->
</html>
