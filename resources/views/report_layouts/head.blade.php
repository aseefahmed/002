...
<head>
    ...
    @if(Route::currentRouteName() == 'Supplier Details' || Route::currentRouteName() == 'Suppliers List' || Route::currentRouteName() == 'Order Report' || Route::currentRouteName() == 'Order Details' || Route::currentRouteName() == 'Add Employee' || Route::currentRouteName() == 'Orders List')    
