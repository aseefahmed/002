...
<!--------------- For Data Tables ---------------------->
@if(Route::currentRouteName() == 'Suppliers List' || Route::currentRouteName() == 'Designation List' || Route::currentRouteName() == 'Order Report' || 
...
@if(Route::currentRouteName() == 'Supplier Details' || Route::currentRouteName() == 'Suppliers List' || Route::currentRouteName() == 'Order Details' || Route::currentRouteName() == 'Order Report' || Route::currentRouteName() == 'Add Employee' || Route::currentRouteName() == 'Orders List')    
